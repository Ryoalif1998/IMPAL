                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">Pemasukan <br>Bulan Ini</h2>
                                <a href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url('../assets/img/bg-img/bg-2.jpg');">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="400ms">Pengeluaran <br>Bulan Ini</h2>
                                <a href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
