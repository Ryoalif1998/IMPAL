...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="<?php echo site_url('CBeranda') ?>" class="simple-text">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Daftar Data Pengeluaran Universitas</h4>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a type="button" class="btn btn-lg btn-warning pe-7s-note" href="<?php echo site_url('pengeluaran/edit/'.$value['id_pengeluaran']);?>"></a>
                                                <a type="button" class="btn btn-lg btn-danger pe-7s-trash" href="<?php echo site_url('pengeluaran/delete/'.$value['id_pengeluaran']);?>" onclick="return confirm('Konfirmasi Penghapusan Data')"></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
