                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Pendataan Keuangan Universitas</h4>
                                <p class="category"></p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    <p class="category" style="margin-left: 15px">Data Pemasukan</p>
                                    <thead>
                                        <th>ID</th>
                                        <th>Universitas</th>
                                        <th>Fakultas</th>
                                ...
                                <table class="table table-hover table-striped">
                                    <p class="category" style="margin-left: 15px">Data Pengeluaran</p>
                                    <thead>
                                        <th>ID</th>
                                        <th>Universitas</th>
                                        <th>Fakultas</th>
