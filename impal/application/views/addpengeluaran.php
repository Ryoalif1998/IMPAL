        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Tambah Pengeluaran</a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Tambah Data Pengeluaran Universitas</h4>
                                <p class="category"></p>
                            </div>
                            <div class="content table-responsive table-full-width" style="margin-left: 15px; margin-right: 15px">
